...
[![GoDoc](https://godoc.org/github.com/Decem-Technology/gocialite?status.svg)](https://godoc.org/github.com/Decem-Technology/gocialite)
[![GoReport](https://goreportcard.com/badge/github.com/Decem-Technology/gocialite)](https://goreportcard.com/report/github.com/Decem-Technology/gocialite)
...
Please see [Contributing page](https://github.com/Decem-Technology/gocialite/blob/master/CONTRIBUTING.md) to learn how to create new driver and test it.
...
Please take a look to [multi provider example](https://github.com/Decem-Technology/gocialite/wiki/Multi-provider-example) for a full working code with Gin Tonic and variable provider handler.
